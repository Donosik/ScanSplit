    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserMenuItems", x => new { x.OrderedById, x.OrderedItemsId });
                    table.ForeignKey(
                        name: "FK_UserMenuItems_MenuItems_OrderedItemsId",
                        column: x => x.OrderedItemsId,
                        principalTable: "MenuItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserMenuItems_Users_OrderedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BillMenuItems", x => new { x.BillId, x.MenuItemsId });
                    table.ForeignKey(
                        name: "FK_BillMenuItems_MenuItems_MenuItemsId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BillImage = table.Column<string>(type: "TEXT", maxLength: 255, nullable: false),
                    GroupId = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Locations_Bills_BillId",
                        column: x => x.BillId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BillMenuItems_MenuItemsId",
                table: "BillMenuItems",
                column: "MenuItemsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserMenuItems_OrderedItemsId",
                table: "UserMenuItems",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_BillMenuItems_Bills_BillId",
                table: "BillMenuItems",
                column: "BillId",
                principalTable: "Bills",
                principalColumn: "Id",
